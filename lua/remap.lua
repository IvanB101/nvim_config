...
remap("v", "R", 'y:%s/<C-r>"/<C-r>"/g<Left><Left>', { desc = "replace ocurrencies of marked text in whole file" })
...
remap("n", "<C-t>", "<cmd>tab split<cr>", { desc = "new tab" })
...
remap("c", "<A-b>", "<S-left>", { desc = "go left one word" })
remap("c", "<A-f>", "<S-right>", { desc = "go right one word" })
